...
const slider = () => {
  const quotesSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.headerTop-quotes_swiper', {
...
const validate = () => {
  const validation = new just_validate__WEBPACK_IMPORTED_MODULE_0__["default"]('#aside-form');
...
/***/ "./src/js/modules/validateText.js":
/*!****************************************!*\
  !*** ./src/js/modules/validateText.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const validateText = () => {
  const validation = new just_validate__WEBPACK_IMPORTED_MODULE_0__["default"]('.reviews-form', {
    tooltip: {
      position: 'bottom'
    }
  });
  validation.addField('#feedback', [{
    rule: 'minLength',
    value: 2,
    errorMessage: 'Не менее 2х символов'
  }, {
...
/* harmony import */ var _modules_validateText__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/validateText */ "./src/js/modules/validateText.js");
/* harmony import */ var _modules_yandexMap__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/yandexMap */ "./src/js/modules/yandexMap.js");
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_inputMask__WEBPACK_IMPORTED_MODULE_3__["default"])();
  (0,_modules_validate__WEBPACK_IMPORTED_MODULE_4__["default"])();
  (0,_modules_validateText__WEBPACK_IMPORTED_MODULE_5__["default"])();
  (0,_modules_yandexMap__WEBPACK_IMPORTED_MODULE_6__["default"])();
});
})();
